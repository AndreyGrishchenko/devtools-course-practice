// Copyright 2022 Grishchenko Andrey

#include <gtest/gtest.h>
#include "include/complex_number.h"

TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Init) {
    // Arrange
    double re = 1.0;
    double im = 2.0;
...
TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Create_Zero) {
    // Arrange
    double re = 0.0;
    double im = 0.0;
...
TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Sum) {
    // Arrange
    double re = 2.0;
    double im = 1.0;
...
TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Difference) {
    // Arrange
    double re = 2.0;
    double im = 1.0;
...
TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Multiplication) {
    // Arrange
    double re = 2.0;
    double im = 3.0;
...
TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Division) {
    // Arrange
    double re = 3.0;
    double im = 4.0;
...
TEST(Grishchenko_Andrey_ComplexNumberTest, Can_Equals_Unqals) {
    // Arrange
    double re = 10.0;
    double im = 20.0;
